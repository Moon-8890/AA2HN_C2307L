...
//	Bài 1:
//- Nhap vào mang gom N so nguyên
//Yêu cau:
//- Tính tong các so chia het cho 5
//- Tìm các so chính phuong (a luy thua 2).
//- Sap xep mang sao cho các phan tu chan o dau mang, các phan tu le o cuoi mang
